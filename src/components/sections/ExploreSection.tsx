...
const ExploreSection: React.FC<ExploreSectionProps> = ({ 
  ...
  const filteredData = insuranceType === 'all'
    ? insuranceData
  ...
  const avgPremium = filteredData.length > 0
    ? filteredData.reduce((sum, item) => sum + item.monthlyPremium, 0) / filteredData.length
    : 0;
    ...
    <section id="explore" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto mb-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Explore Insurance Rates</h2>
          <p className="text-lg text-gray-700">
            Compare anonymously shared insurance rates in your area to make informed decisions about your coverage.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
              ...
              <div className="mb-4 md:mb-0">
                <div className="flex items-center">
                  ...
                  <h3 className="text-xl font-semibold">
                    Results for ZIP: <span className="text-blue-600">{currentZipCode}</span>
                  </h3>
                </div>
                <p className="text-gray-600 mt-1">
                  Showing {filteredData.length} insurance rates • 
                  Average premium: <span className="font-medium">${avgPremium.toFixed(2)}/month</span>
                </p>
              </div>
            ...
            {filteredData.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <h4 className="text-xl font-medium text-gray-800 mb-2">No insurance data found</h4>
                <p className="text-gray-600 mb-6">
                  We don't have any insurance data for this zip code yet. Be the first to share!
                </p>
